...
${errorInfo.componentStack}`);
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/checkout-settings.mjs
  ...
  function Extension() {
    ...
    const zipcode = ShippingAddress == null ? void 0 : ShippingAddress.zip;
    const firstName = ShippingAddress == null ? void 0 : ShippingAddress.firstName;
    const lastName = ShippingAddress == null ? void 0 : ShippingAddress.lastName;
    const Address1 = ShippingAddress == null ? void 0 : ShippingAddress.address1;
    const shippingPhone = ShippingAddress == null ? void 0 : ShippingAddress.phone;
    const CityName = ShippingAddress == null ? void 0 : ShippingAddress.city;
    const ShippingAddressChange = useApplyShippingAddressChange();
    const [PincodeData, setPincodeData] = (0, import_react14.useState)();
    const UseCheckoutSettings = useCheckoutSettings();
    console.log("UseCheckoutSettings>>>", UseCheckoutSettings);
    if (phone && email === void 0) {
    ...
    } else if (phone === void 0 && email === void 0) {
      useBuyerJourneyIntercept(({ canBlockProgress }) => {
        return {
          behavior: "block",
    ...
    if (firstName === void 0) {
      ...
      useBuyerJourneyIntercept(({ canBlockProgress }) => {
        return firstNameLength === 0 && nameRegex.test(firstName) === true || firstNameLength === 0 && nameRegex.test(firstName) === false || firstNameLength !== 0 && nameRegex.test(firstName) === false ? {
          behavior: "block",
    ...
    if (lastName === void 0) {
      ...
      useBuyerJourneyIntercept(({ canBlockProgress }) => {
        return lastNameLength === 0 && lastNameRegex(lastName) === true || lastNameLength === 0 && lastNameRegex.test(lastName) === false || lastNameLength !== 0 && lastNameRegex.test(lastName) === false ? {
          behavior: "block",
    ...
    if (Address1 === void 0) {
      ...
      useBuyerJourneyIntercept(({ canBlockProgress }) => {
        return Address1Length === 0 && Address1Regex.test(Address1) === true || Address1Length === 0 && Address1Regex.test(Address1) === false || Address1Length !== 0 && Address1Regex.test(Address1) === false || Address1Length < 15 && Address1Regex.test(Address1) === true ? {
          behavior: "block",
    ...
    if (zipcode === void 0) {
      ...
      useBuyerJourneyIntercept(({ canBlockProgress }) => {
        return zipcodelength === 0 && zipcodeRegex.test(zipcode) === false || zipcodelength === 0 && zipcodeRegex.test(zipcode) === true || zipcodelength !== 0 && zipcodeRegex.test(zipcode) === false ? {
          behavior: "block",
    ...
    (0, import_react14.useEffect)(() => {
      ...
      if (zipcodelength) {
        fetch(apiUrl).then((response) => {
          ...
          setPincodeData((_a = data[0]) == null ? void 0 : _a.PostOffice[0]);
        }).catch((error) => {
    ...
    const AddShippingAddressChange = () => __async(this, null, function* () {
      const code = yield ShippingAddressChange({
        type: "updateShippingAddress",
        address: {
          provinceCode: `${(PincodeData == null ? void 0 : PincodeData.State) == "undefined"}` ? " " : `${PincodeData == null ? void 0 : PincodeData.State}`,
          city: `${(PincodeData == null ? void 0 : PincodeData.Block) == "NA" || "undefined"}` ? " " : `${PincodeData == null ? void 0 : PincodeData.Block}`
        }
      });
    });
    (0, import_react14.useEffect)(() => {
    ...
    if (CityName === "undefined") {
      ...
      const cityNameRegex = new RegExp("^[A-Za-z ]*(?<!\\.{4})[A-Za-z ]*$");
  ...
  // extensions/checkout-ui/src/Consent.jsx
  var import_jsx_runtime5 = __toESM(require_jsx_runtime());
  var Consent_default = reactExtension(
    "purchase.checkout.contact.render-after",
    () => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Extension2, {})
  );
  function Extension2() {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Text2, { children: [
      "The trusted ",
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Link2, { to: "https://www.hul.co.in/brands/", children: "  Unilever Brands " }),
      " via Email and SMS, Whatsapp and online advertising tailored to my interests and preferences* . Please read our ",
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Link2, { to: "https://www.unilevernotices.com/privacy-notices/india-english.html", children: "Privacy " }),
      "  and ",
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Link2, { to: "https://www.unilevernotices.com/cookie-notices/india-english.html", children: "Cookie Notice" }),
      " to understand how we use your Personal Data. I confirm I am over 18 years old."
    ] }) });
  }
})();
//# sourceMappingURL=checkoutui.js.map
